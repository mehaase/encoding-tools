...
class UrlDecoderGadget extends BaseGadget {
    ...
    GadgetMeta getMeta() {
        return new GadgetMeta('url-decoder', 'web-gadget', 'URL Decode');
    }
    ...
    void transform(List<int> input) {
        ...
        if (input == null) {
            ...
            encoded = Uri.decodeComponent(new String.fromCharCodes(input));
        }
